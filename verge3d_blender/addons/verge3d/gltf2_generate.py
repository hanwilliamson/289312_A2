...
def generateLightProbes(operator, context, exportSettings, glTF):
    ...
    for blProbe in filteredLightProbes:
        probes.append({
            'name': blProbe.name,
            'influenceType': blProbe.influence_type,
            'influenceDistance': blProbe.influence_distance,
            'parallaxType': blProbe.parallax_type if blProbe.use_custom_parallax else blProbe.influence_type,
            'parallaxDistance': blProbe.parallax_distance if blProbe.use_custom_parallax else blProbe.influence_distance,
            'intensity': blProbe.intensity,
            'clipStart': blProbe.clip_start,
            'clipEnd': blProbe.clip_end,
